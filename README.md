...
## Usage
En el directorio padre de `simulador-qfa`, ejecutar:
```
python simulador-qfa
```

También es posible descargar el archivo comprimido `simulador-qfa.zip` y ejecutar el programa:
```
python simulador-qfa.zip
```
